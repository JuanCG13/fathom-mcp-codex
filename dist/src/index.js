...
import { z } from "zod";
import { FathomClient, jsonText, verifyFathomWebhook } from "./fathom.js";
...
}, async (input) => jsonText(await client().get("/meetings", {
    cursor: input.cursor,
...
server.registerTool("fathom_create_webhook", {
    ...
    return jsonText(await client().post("/webhooks", {
